...
var ASM_CONSTS = {
  4431764: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4431819: ($0) => { performance.now = function() { return $0; }; },  
 4431867: ($0) => { performance.now = function() { return $0; }; },  
 4431915: () => { performance.now = Module['emscripten_get_now_backup']; }
};
